...
class VEDGE(VAEMixin, UnsupervisedTrainingMixin, BaseModelClass, ArchesMixin):
    """Integration of multi-modal and single-modality data :cite:p:`AshuachGabitto21`.

    VEDGE is used to integrate multiomic datasets with single-modality (expression
    or accessibility) datasets.

    Parameters
    ----------
    adata
        AnnData object that has been registered via :meth:`~VEDGE.setup_anndata`.
    n_genes
    ...
    **model_kwargs
        Keyword args for :class:`~VEDGE_NET`
    ...
    >>> VEDGE.setup_anndata(adata_mvi, batch_key="modality")
    >>> vaegan = VEDGE(adata_mvi)
    >>> vaegan.train()
    ...
    * The main batch annotation, specified in ``setup_anndata``, should correspond to
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        self.discriminator1=self.module.discriminator_atac
        self.discriminator2=self.module.discriminator_rna
        self.discriminator3=self.module.discriminator_pro
    ...
    def train(
        ...
        **kwargs
        ...
        training_plan = self._training_plan_cls(module=self.module,
                                                        discriminator1=self.discriminator1,
                                                        discriminator2=self.discriminator2,
                                                        discriminator3=self.discriminator3,**plan_kwargs)
    ...
    def get_accessibility_estimates(
        ...
        for tensors in post:
            ...
            p = generative_outputs["p_atac"].cpu()
